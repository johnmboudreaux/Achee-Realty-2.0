    ...
    return fetch('/api/v1/messageReceived', {
      ...
      .then((result) => {
        if (result.status === 201) {
          document.getElementById('contact-form').innerHTML = 'Your message has been sent';
        } else {
          document.getElementById('contact-form').innerHTML = 'An error has occurred please try again later';
        }
      })
